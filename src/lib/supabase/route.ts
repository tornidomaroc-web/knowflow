 ...
 * allowed, and wrong here: on the auth callback a swallowed write means the
 ...
 * buffer onto the response we actually return — the redirect carries the
 * session, or the PKCE verifier, explicitly.
 */
