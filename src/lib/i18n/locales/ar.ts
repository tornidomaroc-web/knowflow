  ...
  dashboard: {
    ...
    settings: {
      ...
      cancelSubscription: {
        ...
        errorPartial: "نجح جزء من العملية فقط. {scheduled} من {total} اشتراكات أصبحت مُجدولة للإنهاء، لكن {failed} لم يُلغَ ولا يزال يُحتسب عليك. يرجى المحاولة مرة أخرى لإلغاء الباقي. وإذا تكرر الفشل تواصل مع الدعم مع ذكر الرقم المرجعي أدناه.",
        reference: "الرقم المرجعي:",
