...
export const ar: Translation = {
  ...
  auth: {
    ...
    noticeSigninRequired: "لم نتمكن من إتمام هذا الرابط هنا. إن كنت تستعيد كلمة المرور، افتح الرابط على الجهاز والمتصفح اللذين طلبته منهما. وإلا فسجل الدخول بالأسفل.",
    ...
    forgotSameDevice: "افتح الرابط على هذا الجهاز وفي هذا المتصفح. لن يعمل في مكان آخر.",
    ...
    resetNoSession: "هذا الرابط غير مفعّل في هذا المتصفح. اطلب رابطاً جديداً وافتحه على الجهاز نفسه الذي طلبته منه.",
