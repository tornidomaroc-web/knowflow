...
export const ar: Translation = {
  ...
  */
  ...
  dashboard: {
    ...
    subjects: {
      subtitle: "مادة واحدة لكل مقرر. كل بطاقة تعرض مدى تقدمك فيها.",
      summarised: "مُلخّصة",
      quizzed: "لها اختبار",
      processing: "قيد المعالجة",
      noMaterials: "لا ملفات بعد. أضف ملفات المقرر أو شرائحه أو ملاحظاتك للبدء.",
      lastAsked: "آخر سؤال",
      lastAdded: "آخر إضافة",
      created: "أُنشئت",
    ...
    subjectDetail: {
      ...
      summaryTodo: "لا ملخص بعد",
      quizDone: "الاختبار جاهز",
      quizTodo: "لا اختبار بعد",
      added: "أُضيف",
    },
    suggestions: {
    ...
    continueCard: {
      ...
      body: "كانت آخر محادثاتك في {subject}.",
      cta: "متابعة",
    },
    newKb: {
      title: "إنشاء مادة",
    ...
    agent: {
      chatWith: "تسأل عن",
      startTyping: "كل إجابة تأتي من ملفات هذه المادة نفسها.",
      emptyTitle: "ما الذي تريد أن تفهمه؟",
    ...
    upload: {
      ...
      leaveNote: "قد تستغرق الملفات الكبيرة دقيقة أو دقيقتين. يمكنك مغادرة الصفحة؛ سيظهر الملف بعد تحديثها حين يكتمل.",
      tryAnother: "اختر ملفًا آخر للمحاولة مجددًا.",
      ready: "جاهز ✓",
      error: "خطأ"
    }
  }
