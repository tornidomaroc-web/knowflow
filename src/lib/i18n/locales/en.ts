...
export const en = {
  ...
  auth: {
    ...
    noticeSigninRequired: "We could not finish that link here. If you were resetting your password, open the link on the same device and browser you asked from. Otherwise, sign in below.",
    ...
    forgotSameDevice: "Open the link on this device, in this browser. It will not work anywhere else.",
    ...
    resetSaving: "Saving...",
    resetNoSession: "This reset link is not active in this browser. Ask for a new one and open it on the same device you asked from.",
