  ...
  return (
    <div className="bg-[var(--bg-color)] text-white min-h-screen py-24" dir={isRtl ? 'rtl' : 'ltr'}>
      <div className="max-w-3xl mx-auto px-6">
        <h1 className="text-5xl font-[family-name:var(--font-playfair)] font-bold mb-4">{t.legal.refund.title}</h1>
        <p className="text-sm font-[family-name:var(--font-mono)] uppercase tracking-widest text-[var(--muted-color)] mb-12">{t.legal.refund.lastUpdated}</p>
        <p className="text-lg text-[var(--muted-color)] mb-12">{t.legal.refund.intro}</p>
