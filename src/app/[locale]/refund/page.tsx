  ...
  return (
    <div className="min-h-screen font-sans py-24" dir={isRtl ? 'rtl' : 'ltr'}>
      <div className="max-w-3xl mx-auto px-6 text-muted-foreground text-start">
        ...
        <p className="mb-6">We offer a 7-day refund window from the date of first charge. To request a refund, contact us at support@tryknowflow.com with your account email. Refunds are processed within 5 to 10 business days.</p>
