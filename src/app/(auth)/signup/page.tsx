    ...
    <div className="flex min-h-screen bg-[var(--bg-color)]">
      ...
      <div className="flex w-full lg:w-1/2 justify-center items-center bg-[var(--input-bg)] p-8 text-white">
        <form onSubmit={handleSignup} className="w-full max-w-sm space-y-6">
          ...
          <h2 className="text-3xl font-[family-name:var(--font-playfair)] font-bold">Create Account</h2>
          <p className="text-[var(--muted-color)] font-[family-name:var(--font-sans)] text-sm mb-8">Join KnowFlow today</p>
          ...
          <div className="space-y-4 font-[family-name:var(--font-mono)] text-sm">
            <div className="flex flex-col space-y-2">
              <label className="text-[var(--muted-color)]">Full Name</label>
