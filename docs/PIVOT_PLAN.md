...
| B5a | **No upload extension/MIME allowlist:** unexpected file types reach MarkItDown unchecked. | Medium (security) | **Phase 0** | Cheap (3–4 lines in the same `/api/ingest` handler as B4); pulled forward to ride along. Size cap: **4 MB** since #189 (2026-09-23, register #50 decision 1); the platform refuses any request past about 4,500,000 bytes, body and headers together. *Corrected 2026-09-23; this said: “Size cap (50 MB) already exists.”* |
