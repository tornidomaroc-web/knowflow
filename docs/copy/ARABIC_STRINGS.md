...
## Site header and nav (`nav`)

| Key | العربية | English |
|---|---|---|
| `nav.home` | KnowFlow | KnowFlow |
...
| `landing.sampleEnA` | It measures how much quantity demanded changes when the price changes. | It measures how much quantity demanded changes when the price changes. |
| `landing.kitSummary` | الملخص جاهز | Summary ready |
| `landing.kitQuiz` | الاختبار جاهز | Quiz ready |
...
## Landing (how it works) (`howItWorks`)
...
| Key | العربية | English |
|---|---|---|
| `pricing.title` | أسعار شفافة وبسيطة. | Simple, transparent pricing. |
| `pricing.free.name` | مجاني | Free |
| `pricing.free.price` | $0 | $0 |
| `pricing.free.period` | /شهرياً | /month |
| `pricing.free.features[0]` | 5 مواد | 5 Subjects |
| `pricing.free.features[1]` | 10 ملفات لكل مادة | 10 materials per subject |
| `pricing.free.features[2]` | 100 محادثة/شهر | 100 conversations/month |
| `pricing.free.features[3]` | بالعربية والإنجليزية | Arabic & English |
| `pricing.free.button` | ابدأ مجاناً | Start free |
| `pricing.pro.name` | احترافي | Pro |
| `pricing.pro.price` | $49 | $49 |
| `pricing.pro.period` | /شهرياً | /month |
| `pricing.pro.features[0]` | مواد أكثر بكثير | Many more subjects |
| `pricing.pro.features[1]` | حدود سخية للملفات | Generous material limits |
| `pricing.pro.features[2]` | حدود يومية عالية | High daily limits |
| `pricing.pro.button` | الترقية للاحترافي | Upgrade to Pro |
| `pricing.checkout.unavailable` | تعذّر الوصول إلى مزوّد الدفع. يرجى المحاولة مرة أخرى بعد قليل. | We could not reach the payment provider. Please try again in a moment. |
| `pricing.checkout.misconfigured` | الدفع غير متاح حالياً. المشكلة من جانبنا، وقد تم إبلاغ فريقنا. | Checkout is not available right now. This is a problem on our side, and our team has been notified. |
| `pricing.checkout.failed` | حدث خطأ أثناء بدء عملية الدفع. يرجى المحاولة مرة أخرى. | Something went wrong starting checkout. Please try again. |
| `pricing.checkout.reference` | الرقم المرجعي: | Reference: |

## Login, signup, password pages (`auth`)
...
| `auth.showPassword` | إظهار كلمة المرور | Show password |
| `auth.passwordMismatch` | كلمتا المرور غير متطابقتين. | The two passwords don't match. |
...
| `dashboard.nav.signOut` | تسجيل الخروج | Sign Out |

## Signed-in app: passwordReplaced (`dashboard.passwordReplaced`)
...
| `dashboard.home.streakUnit.two` | يومان |  |
| `dashboard.home.streakUnit.few` | أيام |  |
...
| `dashboard.home.viewAll` | عرض الكل | View all |
| `dashboard.home.unknownKb` | مادة غير معروفة | Unknown subject |
...
- `dashboard.home.streakUnit.zero`
- `dashboard.home.streakUnit.two`
- `dashboard.home.streakUnit.few`
- `dashboard.home.streakUnit.many`
